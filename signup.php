    ...
    <div class="container5">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="./sign-up-qry.php" class="sign-in-form" method="post">
          <?php
...
?>
            ...
            <input type="submit" value="signup" class="btn solid"  name="signup"/>
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          ...
          Already have an account!
           Click the below button for signing in!!!
            </p>
