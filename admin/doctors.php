...
?>
          ...
          <div class="form-container">
            <form action="./add-doctor-qry.php" method="POST" enctype="multipart/form-data" class="row">

              <div class="col-lg-6 mb-4">
                <label class="form-label" for="name" style="color: blue;">Doctor Name <span class="text-danger">*</span>
                </label>
                <input type="text" class="form-control" id="name" name="docname" placeholder="Enter here..." required>
              </div>
              <div class="col-lg-6 mb-4">
                <label class="form-label" for="email" style="color: blue;">Speciality <span class="text-danger">*</span>
                </label>
                <input type="text" class="form-control" id="email" name="speciality" placeholder="Enter here..." required>
              </div>
              ...
              <div class="col-lg-6 mb-2">
                ...
                <input type="file" class="form-control" id="image" name="image" required>
                  ...
                  <div class="col-lg-6 mb-2">
                    ...
                    <input type="text" class="form-control" id="address" name="acheck_up" placeholder="Enter here..." required>
                  </div>
