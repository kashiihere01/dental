    ...
    <div class="row clearfix">
      ...
      <div class="card">
        ...
        <div class="container mt-3 bg-white p-4">
          <div class="col-4">
            <h3 style="color: blue;"> <i class="fas fa-user-edit " style="color: blue; font-size:2.5rem;"></i> Edit Doctors</h3>
          </div>
          <div class="col-8">
            <?php
        ...
        <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span>
          ...
          <div class="form-container">
            <form action="./update-doctor-qry.php" method="POST" enctype="multipart/form-data" class="row">
              ...
              <div class="col-lg-6 mb-4">
                ...
                <input type="text" class="form-control" id="name" name="docname" value="<?= $row['doctor_name'] ?>" placeholder="Enter here..." required>
              </div>
              <div class="col-lg-6 mb-4">
                <label class="form-label" for="email" style="color: blue;">Speciality <span class="text-danger">*</span>
                </label>
                <input type="text" class="form-control" id="email" value="<?= $row['speciality'] ?>" name="speciality" placeholder="Enter here..." required>
              </div>
              ...
              <div class="col-lg-6 mb-2">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" value="<?= $row['start_time'] ?>" name="stime" class="form-control timepicker">
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-6 mb-2">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="etime" value="<?= $row['end_time'] ?>" class="form-control timepicker">
                  </div>
                </div>
              </div>

              <div class="col-lg-6 mb-2">
                <label class="form-label" for="image" style="color: blue;">Doctor Image <span class="text-danger">*</span>
                </label>

                <input type="file" class="form-control" id="userimage" name="new_image" accept="image/*">
                <input type="hidden" class="form-control" value="<?= $row['doctor_image'] ?>" name="old_image" accept="image/*" required>
              </div>
          ...
          <div class="col-lg-6 mb-2">
            ...
            <input type="text" class="form-control" id="address" value="<?= $row['checkup_average_time'] ?>" name="acheck_up" placeholder="Enter here..." required>
          </div>

          <div class="col-lg-12 mb-2">
            <label class="form-label" for="val-username" style="color: blue;">Description <span class="text-danger">*</span>
            </label>
            <textarea name="description" class="form-control" id="" rows="1"><?= $row['description'];  ?></textarea>
          </div>

          <div class="offset-8 col-lg-4 mb-2">
            <label for=""></label>

            <button class="btn btn-primary text-white btn-lg mt-2 w-100 " type="submit" name="submit" value="signup"> <i class="fa fa-user-edit"></i> Update Doctors</button>
          </div>
