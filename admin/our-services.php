    ...
    <div class="main-content">
        ...
        <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span>
                    ...
                    <div class="form-container">
                        <form action="./add-service-qry.php" method="POST" enctype="multipart/form-data" class="row">

                            <div class="col-lg-6 mb-2">
                                <label class="form-label" for="name" style="color: blue;"> Service <span class="text-danger">*</span>
                                </label>
                                <input type="text" class="form-control" id="name" name="service" placeholder="Enter here..." required>
                            </div>
...
?>
  ...
  <tr>
  <td><?= $sr ?></td>
  <td><img src="./images/services/<?php echo $row['image'] ?>" alt="services Image" height="60px"></td>
      <td><?= $row['service'] ?></td>
