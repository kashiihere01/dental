          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <?php
                        ...
                        ?>
                <form method="POST" action="./login-qry.php" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-lg btn-block" name="login" value="login" tabindex="4">
                      Login
                    </button>
                  </div>
                </form>
